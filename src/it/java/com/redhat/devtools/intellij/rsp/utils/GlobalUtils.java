 ...
 ******************************************************************************/
package com.redhat.devtools.intellij.rsp.utils;
...
import com.redhat.devtools.intellij.rsp.dialogs.IdeFatalErrorsDialogFixture;
import com.redhat.devtools.intellij.rsp.dialogs.ProjectStructureDialogFixture;
import com.redhat.devtools.intellij.rsp.dialogs.TipOfTheDayDialogFixture;
import com.redhat.devtools.intellij.rsp.dialogs.WelcomeFrameDialogFixture;
import com.redhat.devtools.intellij.rsp.mainIdeWindow.CustomHeaderMenuBarFixture;
import com.redhat.devtools.intellij.rsp.mainIdeWindow.IdeStatusBarFixture;
import com.redhat.devtools.intellij.rsp.mainIdeWindow.LinuxIdeMenuBarFixture;
import com.redhat.devtools.intellij.rsp.popups.SearchEverywherePopupFixture;
...
import static com.redhat.devtools.intellij.rsp.utils.HelperUtils.listOfRemoteTextToString;
    ...
    public static void checkForExceptions(RemoteRobot remoteRobot) {
        step("Check for exceptions and other errors", () -> {
            ...
            for (int i = 0; i < numberOfExceptions; i++) {
                listOfRemoteTextToString(ideFatalErrorsDialogFixture.exceptionDescriptionJTextArea().findAllText());
