...
import com.redhat.devtools.intellij.rsp.other.ActionLinkFixture;
...
public class WelcomeFrameDialogFixture extends ContainerFixture {
    ...
    public ComponentFixture importProjectLink() {
        return find(ComponentFixture.class, byXpath("//div[@text='Open or Import' and @class='ActionLink']"));
    }
